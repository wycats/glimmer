import type { Cursor as ICursor, ElementBuilder, Environment } from '@glimmer/interfaces';
...
export class JitSerializationDelegate extends NodeJitRenderDelegate {
  ...
  override getElementBuilder(env: Environment, cursor: ICursor): ElementBuilder {
